            ...
            <form>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <!--<li role="presentation"><a href="#">Messages </a></li>-->
                        <li role="presentation"><a href="account_setting.php">My Setting </a></li>
            ...
            <div class="container">
                ...
                <ul class="nav navbar-nav hidden-md hidden-lg navbar-right">
                    ...
                    <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                        ...
                        <!--<li role="presentation"><a href="#">Messages</a></li>-->
                        <li role="presentation"><a href="notify.php">Notifications</a></li>
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li role="presentation"><a href="profile.php?username=<?php echo $_SESSION["username"]; ?>">My Profile</a></li>
                                <li class="divider" role="presentation"></li>
                                <li role="presentation"><a href="home.php">Timeline </a></li>
